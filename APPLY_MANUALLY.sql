-- INSTRUCTIONS:
-- 1. Go to Supabase Dashboard: https://supabase.com/dashboard/project/drfaomantrtmtydbelxe/sql/new
-- 2. Copy and paste this entire SQL file
-- 3. Click "Run" to apply the changes
-- 4. Then deploy the Edge Function using: supabase functions deploy accept-project-invitation

-- ============================================================================
-- UPDATE RLS POLICIES FOR PROJECT SHARING
-- ============================================================================

-- Drop the old SELECT policy for projects
