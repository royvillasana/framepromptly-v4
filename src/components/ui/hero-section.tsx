...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-primary-light/20 to-primary-light/10">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-grid-pattern opacity-5" />
      <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-gradient-primary rounded-full blur-3xl opacity-20" />
      <div className="absolute bottom-1/4 left-1/4 w-48 h-48 bg-gradient-secondary rounded-full blur-2xl opacity-15" />
      ...
      <div className="relative container mx-auto px-6 py-24 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.h1
            ...
            className="text-5xl lg:text-7xl font-bold mb-8 bg-gradient-hero bg-clip-text text-transparent leading-tight"
          >
            Build UX Workflows
            <br />
          ...
          >
            ...
            <Card className="p-6 bg-card/50 backdrop-blur-sm border-border/50 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg font-semibold mb-2">AI Prompt Generation</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <Card className="p-6 bg-card/50 backdrop-blur-sm border-border/50 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-lg font-semibold mb-2">UX Framework Library</h3>
              <p className="text-muted-foreground text-sm">
