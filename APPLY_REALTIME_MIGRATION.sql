...
-- =====================================================
-- This enables real-time collaboration features for the workflow canvas
-- Similar to Figma's multi-user collaboration
-- =====================================================
...
BEGIN
    ...
    -- If it already exists, this will be caught and ignored
    BEGIN
        ALTER PUBLICATION supabase_realtime ADD TABLE public.projects;
        RAISE NOTICE 'Added projects table to realtime publication';
    EXCEPTION
        WHEN duplicate_object THEN
            RAISE NOTICE 'Projects table already in realtime publication - skipping';
    END;
END $$;
...
DO $$
BEGIN
    RAISE NOTICE '✅ Realtime collaboration migration applied successfully!';
    RAISE NOTICE '';
    RAISE NOTICE '📋 IMPORTANT - Next step: Enable Realtime Replication';
    RAISE NOTICE '   This is REQUIRED for the feature to work!';
    RAISE NOTICE '';
    RAISE NOTICE '   1. Go to Database → Replication in Supabase Dashboard';
    RAISE NOTICE '   2. Find the "projects" table in the list';
    RAISE NOTICE '   3. Toggle the switch next to "projects" to enable it';
    RAISE NOTICE '   4. Click Save (if there is a save button)';
    RAISE NOTICE '';
    RAISE NOTICE '🧪 Testing:';
    RAISE NOTICE '   - Open app in 2 browsers, sign in as different users';
    RAISE NOTICE '   - Navigate to same project in both browsers';
    RAISE NOTICE '   - You should see other users cursors and selections!';
END $$;
